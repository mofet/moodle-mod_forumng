...
$string['discussionoptions'] = 'הגדרות דיון';
...
$string['displayperiod'] = 'זמין בין התאריכים';
...
$string['group'] = 'קבוצה';
$string['hasunreadposts'] = '( {$a} פרסומים שטרם נצפו)';
...
$string['postdiscussion'] = 'פרסום דיון';
...
$string['sharedviewinfoclone'] = '<strong>זו היא קבוצת־דיון שיתופית</strong>. הפורום <a href=\'{$a->url}\'>המקורי</a> מצוי ב {$a->shortname}.';
...
$string['timeend'] = 'עד תאריך';
$string['timestart'] = 'זמין מתאריך';
$string['to'] = 'ל: {$a}';
